...
class LRUCache:
    ...
    def put(self, key: int, value: int) -> None:
        if key in self.hash_table.keys():
            ...
            if self.size == self.capacity:
                ...
                remove_key = remove_node.key
                del self.hash_table[remove_key]
                self.remove_least_recent(remove_node)
                self.size -= 1
    ...
    def remove_least_recent(self, remove_node):
        new_headnext = remove_node.next
        self.head.next = new_headnext
        new_headnext.prev = self.head
